...
class Login extends Component {
  ...
  submitForm = async event => {
    ...
    if (response.ok === true) {
      ...
      this.setState({errorMsg: data.error_msg, loading: false})
    }
  }

  render() {
    const {username, password, showPassword, errorMsg, loading} = this.state
          ...
          >
            ...
            >
              ...
              <InputSubmit
                style={{
                  color: 'white',
                  backgroundColor: loading ? '#757575' : '#0062ff',
                }}
                type="submit"
                disabled={loading}
